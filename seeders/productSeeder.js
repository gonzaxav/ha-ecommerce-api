...
module.exports = async () => {
  const products = [
    ...
    },
    {
      ...
      category: "Merch",
      featured: false,
      shortDescription: "Vaso térmico de doble pared.",
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      category: "Bazar",
      featured: false,
      shortDescription: "Balanza digital",
      isActive: true,
    },
    {
    ...
    {
      name: "Kit colombiano",
      description: "1k café colombiano con cafetera francesa",
      photo: "Kit-regalo-1.png",
      price: "1600",
      stock: 10,
      category: "Kits de regalos",
      featured: false,
      shortDescription: "1k café colombiano con prensa francesa",
      isActive: true,
    },
    {
      name: "Kit café mundial",
      description: "Café colombiano, brasileño, etíope",
      photo: "kits_1.png",
      price: "2000",
      stock: 15,
      category: "Kits de regalos",
      featured: false,
      shortDescription: "Café colombiano, brasileño, etíope",
      isActive: true,
    },
  ];
